...
| What does it defend against? | [security/threat-coverage.md](../../security/threat-coverage.md) — 19 threats, 8 direct, 9 partial, 2 structural, 0 uncovered at signature |
| What does it *not* defend against? | [security/residual-risk.md](../../security/residual-risk.md) — 38 entries with stable ids at signature |
...
> **The counts in this record are the ones these signatures were given against, and they
> do not move.** The threat index and the register have both grown since: entries from
> `RR-039` onward, and the model-provider threats, belong to work this approval never saw.
> The live numbers are in [security/residual-risk.md](../../security/residual-risk.md) and
> [security/threat-coverage.md](../../security/threat-coverage.md).
