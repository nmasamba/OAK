...
| What does it *not* defend against? | [security/residual-risk.md](../../security/residual-risk.md) — 39 entries with stable ids |
...
39 entries with stable ids, severities scored for the shipped configuration, and an explicit
